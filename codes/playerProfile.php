...
// 3. CHECK PERMISSIONS FOR SENSITIVE DATA
// Default: Hide sensitive info (Contract, NID, Phone, Address)
$show_sensitive = false;

// Rule A: I am viewing myself
if ($target_id == $current_user_id) {
    $show_sensitive = true;
}
// Rule B: I am a Head Coach or Assistant Coach
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            <?php if ($user_role == 'coach'): ?>
                <?php 
                // DETERMINE WHICH TAB SHOULD BE BLUE
                // Default: My Squad
                $squad_active = 'active';
                $scout_active = '';
            ...
            <?php else: ?>
                <a href="playerProfile.php" class="nav-item <?php echo ($target_id == $current_user_id) ? 'active' : ''; ?>">Profile</a>
                
                <?php if (isset($base['Role']) && $base['Role'] == 'regular_player'): ?>
                    <a href="mySquad.php" class="nav-item <?php echo ($target_id != $current_user_id) ? 'active' : ''; ?>">My Squad</a>
                    <a href="medicalReport.php" class="nav-item">Medical Report</a>
                <?php endif; ?>
            ...
            <div class="top-section">
                <div class="photo-box">
                    <div class="photo-placeholder">
                        <img src="images/players/<?php echo $target_id; ?>.jpg" alt="No Photo" onerror="this.style.display='none'; this.parentNode.innerText='Photo'">
                    </div>
                </div>
                ...
                <div class="details-box">
                    ...
                    <div class="info-grid">
                        <div class="info-item"><label>Age</label><div class="val"><?php echo htmlspecialchars($base['Age']); ?> Years</div></div>
                        <div class="info-item"><label>Date of Birth</label><div class="val"><?php echo htmlspecialchars($base['Date_of_Birth']); ?></div></div>
                        <div class="info-item"><label>Position</label><div class="val"><?php echo htmlspecialchars($base['Position']); ?></div></div>
                        <div class="info-item"><label>Foot</label><div class="val"><?php echo htmlspecialchars($base['Preferred_foot']); ?></div></div>
                        <div class="info-item">
                        ...
                        <div class="info-item"><label>Height</label><div class="val"><?php echo htmlspecialchars($base['Height']); ?> cm</div></div>
                        <div class="info-item"><label>Weight</label><div class="val"><?php echo htmlspecialchars($base['Weight']); ?> kg</div></div>
                        <div class="info-item"><label>Phone</label><div class="val"><?php echo htmlspecialchars($base['Phone_No']); ?></div></div>
                        <div class="info-item"><label>NID</label><div class="val"><?php echo $base['NID'] ? htmlspecialchars($base['NID']) : 'N/A'; ?></div></div>
                        <div class="info-item full"><label>Email</label><div class="val"><?php echo htmlspecialchars($base['Email']); ?></div></div>
                        <div class="info-item full"><label>Address</label><div class="val"><?php echo $base['Address'] ? htmlspecialchars($base['Address']) : 'N/A'; ?></div></div>
                    </div>
                </div>
            </div>
            ...
            <div class="bottom-section">
                ...
                <?php if ($base['Role'] == 'scouted_player'): ?>
                    <div class="info-content">
                        <div class="data-row"><span class="data-label">Experience:</span> <?php echo $spec['Scouted_Player_Experience']; ?></div>
                        <div class="data-row"><span class="data-label">Previous Club:</span> <?php echo $spec['Scouted_Player_Previous_Club']; ?></div>
                        <div class="bio-box"><label>Bio</label><p>"<?php echo htmlspecialchars($spec['Bio']); ?>"</p></div>
                    </div>
                ...
                <?php else: ?>
                    <div class="split-grid <?php echo !$show_sensitive ? 'single-col' : ''; ?>">
                        ...
                        <div class="info-content">
                            ...
                            <div class="stats-row">
                                <div class="stat-pill"><span class="lbl">Salary</span><span class="num" style="color: #16a34a;">$<?php echo number_format($base['salary']); ?></span></div>
                                <div class="stat-pill"><span class="lbl">Start</span><span class="num"><?php echo $base['contract_start_date']; ?></span></div>
                                <div class="stat-pill"><span class="lbl">End</span><span class="num"><?php echo $base['contract_end_date']; ?></span></div>
                            </div>
                        </div>
                        <?php endif; ?>
