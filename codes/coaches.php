...
// 2. CHECK IF CURRENT USER IS HEAD COACH
// We need to fetch the specific coach type for the logged-in user
$is_head_coach = false;
if ($user_role == 'coach') {
...
// 3. FETCH ALL COACHES (Sorted by Name)
$query = "SELECT 
            u.User_ID, 
            u.Name, 
            c.Coach_Type, 
            ...
            <div class="filter-bar">
                ...
                <div class="filter-right">
                    ...
                    <div class="search-wrapper">
                        ...
                        <button id="searchBtn" type="button" style="padding: 0 20px; background: var(--brand-blue); color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: 700;">Search</button>
                    </div>
                </div>
