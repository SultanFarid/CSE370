    ...
    <div class="team-container">
        ...
        <div class="team-name"><?php echo htmlspecialchars($fixture['Opponent']) ?></div>
                                    ...
                                    <div class="match-meta">
                                        ...
                                        <div class="stadium-info">📍 <?php echo htmlspecialchars($fixture['Stadium']); ?></div>
                ...
                <div id="previous-section" class="tab-section">
                    ...
                    <div class="fixtures-list">
                        ...
                        <?php else: ?>
                            ...
                            ?>
                            <div class="match-box <?php echo $fixture['result']; ?>" data-result="<?php echo $fixture['result']; ?>" data-venue="<?php echo $fixture['venue']; ?>">
                                    ...
                                    <div class="details-content-full">
                                        ...
                                        <div class="mvp-section-top">
                                            ...
                                            <div>
                                                ...
                                                <div class="mvp-name-top"><?php echo htmlspecialchars($fixture['MVP']); ?></div>
                                            </div>
                                        </div>
                                        <?php endif; ?>
                                        
                                        <!-- Football Field with Tactical Formation -->
                                            ...
                                            <div class="tactical-grid">
                                                ...
                                                <div class="position-slot gk-slot">
                                                    ...
                                                    <div class="player-card-field">
                                                        ...
                                                        <div class="player-rating-badge"><?php echo $player['Rating'] ?: 'N/A'; ?></div>
                                                        <?php if ($player['Goals_Scored'] > 0): ?>
                                                            <div class="goal-badge">⚽<?php echo $player['Goals_Scored']; ?></div>
                                                        <?php endif; ?>
                                                        <div class="player-name-field"><?php echo htmlspecialchars($player['Name']); ?></div>
                                                        <div class="player-number-field">#<?php echo $player['Jersey_No']; ?></div>
                                                ...
                                                <!-- CB (Center-Left, 2 players stacked) -->
                                        ...
                                        <div class="substitutes-section">
                                            ...
                                            <div class="substitutes-grid">
                                                ...
                                                <div class="substitute-card">
                                                    ...
                                                    <div class="sub-info">
                                                        <div class="sub-name"><?php echo htmlspecialchars($player['Name']); ?></div>
                                                        <div class="sub-details">
                                                            <span class="sub-position"><?php echo $player['Position']; ?></span>
                                                            <span class="sub-number">#<?php echo $player['Jersey_No']; ?></span>
                                                        </div>
                                                        <?php if ($player['Rating']): ?>
                                                            <div class="sub-rating">Rating: <?php echo $player['Rating']; ?></div>
                                                        <?php endif; ?>
                                                        <?php if ($player['Goals_Scored'] > 0): ?>
                                                            <div class="sub-goals">⚽ <?php echo $player['Goals_Scored']; ?> goal(s)</div>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <?php endforeach; ?>
